locals {
  ...
  vcn_name                         = var.vcn_create ? oci_core_vcn.red5pro_vcn[0].display_name : data.oci_core_vcn.test_existing_vcn[0].display_name
  subnet_id                        = var.vcn_create ? oci_core_subnet.red5pro_vcn_subnet_public[0].id : var.subnet_id_existing
  subnet_name                      = var.vcn_create ? oci_core_subnet.red5pro_vcn_subnet_public[0].display_name : data.oci_core_subnet.test_existing_subnet[0].display_name
  enable_ipv6                      = false
