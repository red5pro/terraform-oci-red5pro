...
# Same endpoint the OCI load balancer health checks: Traefik routes
# PathPrefix(/as/v1/admin) on the plain "web" entrypoint and strips /as/v1/,
# so this reaches as-admin's own /admin/healthz.
